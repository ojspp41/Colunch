...
function Matching() {
    ...
    const handleButtonClick = (index, cost) => {
        setMatchState((prev) => {
            ...
            // 비용 계산 로직
            const newPoint = newIsUseOption[index] ? prev.point + cost : prev.point - cost;
        ...
        <div className="container">
            ...
            <div className="matchcontent">
                <div className="match-title">
                    ...
                    <div className="match-title-inst-txt">매칭되고 싶은 상대를 입력하세요</div>
                </div>
            </div>
            <div className="matchcontent_mbti">
                <div className="match-title">
                    ...
                    <div className="match-title-inst-txt">상대방의 MBTI 2개를 골라주세요.</div>
                </div>
                <MBTISection
                ...
                <div className="match-title">
                    ...
                    >
                        <div>
                            ...
                            <div className="match-title-inst-txt">상대의 나이를 골라주세요</div>
                        </div>
                        <MatchOptionButton
                ...
                {MatchState.isUseOption[1] && (
                    <div className="match-select-button">
                        <AgeButton
                            ...
                            text="자주"
                            value="FREQUENT"
                            onClick={() => handleAgeSelection("FREQUENT", "contact_frequency_option")}
                        ...
                        <AgeButton
                            ...
                            text="보통"
                            value="NORMAL"
                            onClick={() => handleAgeSelection("NORMAL", "contact_frequency_option")}
                            isClickable={MatchState.isUseOption[1]}
                        />
                        <AgeButton
                            formData={MatchState.formData.contact_frequency_option}
                            text="가끔"
                            value="NOT_FREQUENT"
                            onClick={() => handleAgeSelection("NOT_FREQUENT", "contact_frequency_option")}
                            isClickable={MatchState.isUseOption[1]}
                        />
                    </div>
                )}
            ...
            >
                <div
                    ...
                    style={{
                        ...
                        boxShadow: isMBTISelected ? '0px 4px 12px rgba(0, 0, 0, 0.1)' : 'none', // 선택되면 박스쉐도우 추가
                    }}
                >
                    <img
                        src={isMBTISelected ? "/assets/slider_active.svg" : "/assets/slider.svg"} // 이미지 변경
                        alt=""
                        style={{
